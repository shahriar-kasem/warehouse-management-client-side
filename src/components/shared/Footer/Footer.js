    ...
    return (
        <footer>
            <div className='bg-emerald-400 text-white py-3 font-bold'>
                <p className='py-1'>Follow us on: <FontAwesomeIcon icon={faArrowRight}></FontAwesomeIcon> <a target='_blank' href="https://www.facebook.com/">Facebook</a> , <FontAwesomeIcon icon={faArrowRight}></FontAwesomeIcon> <a target='_blank' href="https://twitter.com/">Twitter</a> </p>
